...
const delincuenteSchema = z.object({
...
const estatusPenitenciarioSchema = z.object({
...
const formSchema = personaSchema.merge(delincuenteSchema).merge(estatusPenitenciarioSchema)
    ...
    <div className="space-y-6">
      ...
      {showSuccess && (
        <Alert className="bg-green-500/10 text-green-500 border-green-500/20">
          ...
          <AlertDescription>La persona ha sido guardada correctamente. Puedes registrar otra persona.</AlertDescription>
        </Alert>
      )}
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>ID Cárcel</FormLabel>
                          <FormControl>
                            <Input placeholder="ID Cárcel" type="number" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
